...
import { FaLinkedinIn, FaFacebookF, FaUser, FaLock, FaList, FaWhatsapp } from 'react-icons/fa'
...
const Headers = () => {
    ...
    const redirectWhatsapp = () => {
        window.location.href = "whatsapp://send?phone=+8801797609489";
    };
                ...
                <div className={`w-[300px] z-[9999] transition-all duration-200 fixed  ${showShidebar ? '-left-[300px]' : 'left-0'} top-0 overflow-y-auto bg-white h-screen py-6 px-8`}>
                    <div className='flex justify-start flex-col gap-6'>
                        ...
                        <div className='w-full flex justify-end md-lg:justify-start gap-3 items-center'>
                            <div onClick={redirectWhatsapp} className='w-[48px] h-[48px] rounded-full flex bg-[#25D366] justify-center items-center'>
                                <span><FaWhatsapp style={{ color: "#FFF" }} /></span>
                            </div>
                            <div className='flex justify-end flex-col gap-1'>
                                <h2 onClick={redirectWhatsapp} className='text-sm font-medium text-slate-700'>+8801797609489</h2>
                                <span onClick={redirectWhatsapp} className='text-xs'>WhatsApp support</span>
                            </div>
                        </div>
                    ...
                    <div className='w-9/12 pl-8 md-lg:pl-0 md-lg:w-full'>
                        <div className='flex flex-wrap w-full justify-between items-center md-lg:gap-6'>
                            ...
                            <div className='w-4/12 block md-lg:hidden pl-2 md-lg:w-full md-lg:pl-0'>
                                <div className='w-full flex justify-end md-lg:justify-start gap-3 items-center'>
                                    <div onClick={redirectWhatsapp} className='w-[48px] h-[48px] rounded-full flex bg-[#f5f5f5] justify-center items-center'>
                                        <span><FaWhatsapp /></span>
                                    </div>
                                    <div className='flex justify-end flex-col gap-1'>
                                        <h2 onClick={redirectWhatsapp} className='text-md font-medium text-slate-700'>+8801797609489</h2>
                                        <span onClick={redirectWhatsapp} className='text-sm'>WhatsApp support </span>
                                    </div>
                                </div>
                            </div>
                        </div>
