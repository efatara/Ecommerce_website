                ...
                <div className='w-3/12 lg:w-4/12 sm:w-full'>
                    <div className='flex flex-col gap-3'>
                        ...
                        <ul className='flex flex-col gap-2 text-slate-600'>
                            ...
                            <li>Phone : +8801797609489</li>
                            <li>Email : mail@example.com</li>
                            <li className='flex gap-4'>
                                <img src='http://localhost:3000/images/vat.jpg' alt='Image 1' style={{ height: '150px' }} />
                                <img src='http://localhost:3000/images/iso.png' alt='Image 2' style={{ width: '150px' }} />
                            </li>
